    ...
    public class PortableCamera : Mod
    {
        ...
        public override byte[] Icon
        {
            get
            {
                ...
                {
                    Properties.Resources.icon1.Save(ms, System.Drawing.Imaging.ImageFormat.Png);
                    return ms.ToArray();
                }
            }
        }
        ...
        SettingsSliderInt slider_camfov, slider_cammovespeed, slider_camrotspeed;
        ...
        void CameraSetup()
        {
            ...
            cameraitemCam = new GameObject("CameraItemCam").AddComponent<Camera>();
        ...
        private void Mod_Settings()
        {
            ...
            slider_camfov = Settings.AddSlider("cam_fov", "Camera FOV", 50, 160, 90);
            slider_cammovespeed = Settings.AddSlider("cam_movespeed", "Camera Move Speed", 1, 1000, 50);
            slider_camrotspeed = Settings.AddSlider("cam_rotspeed", "Camera Rotation Speed", 1, 1000, 50);
        ...
        private void Mod_Update()
        {
            ...
            if (keyb_switchcam.GetKeybindDown())
            {
                ...
                bool hidehud = false;
                hidehud = switchedCam && hideHUDwhileSwitched;
